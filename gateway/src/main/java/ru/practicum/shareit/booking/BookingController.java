...
public class BookingController {
    ...
    public ResponseEntity<Object> getAllBookingsForItemsOwner(
        ...
        log.info(
                "Get all bookings for itemOwnerId={}, with stateParam={}, from={}, size={}",
                itemOwnerId, stateParam, from, size
        );
        BookingState state = BookingState.from(stateParam)
                .orElseThrow(() -> new IllegalArgumentException("Unknown state: " + stateParam));
        return bookingClient.getAllBookingsForItemsOwner(itemOwnerId, state, from, size);
    }
